...
def test_tree_best_depth(X_train, y_train, X_test, y_test, m_criterion='entropy', max_depth=100):
    accuracy_data = {
        'depth': [],
        'data': []
    }
    ...
    for depth in range(1, max_depth):
        clf = tree.DecisionTreeClassifier(criterion=m_criterion, max_depth=depth)
